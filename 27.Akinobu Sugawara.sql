...
--
-- Host: localhost:3306
-- Generation Time: Apr 01, 2021 at 03:50 AM
...
INSERT INTO `gs_bm_table` (`id`, `選手名`, `チーム名`, `ポジション`, `誕生日`, `年齢`, `身長`, `体重`, `出身地`, `投打`, `血液型`, `ドラフト年度`, `経歴`, `獲得タイトル`) VALUES
(4, '大田 泰示', '北海道日本ハムファイターズ', '外野手', '1990-06-09', 30, 188, 93, '広島県', '右投げ/右打ち', 'O型', 2008, '東海大相模高-読売（ドラフト1位・09～16）-北海道日本ハム（17～） 2019シーズンより背番号を【5】へ変更', 'ゴールデングラブ賞（2020）'),
(5, '清宮 幸太郎', '北海道日本ハムファイターズ', '内野手', '1999-05-25', 21, 184, 99, '東京都', '右投げ/左打ち', 'O型', 2017, '早稲田実高-北海道日本ハム（ドラフト1位・18～）', ''),
(6, '中田 翔', '北海道日本ハムファイターズ', '内野手', '1989-04-22', 31, 184, 99, '広島県', '右投げ/右打ち', 'O型', 2007, '大阪桐蔭高-北海道日本ハム（高校生ドラフト1巡目・08～）', '最多打点（2014、2016、2020） ベストナイン 外野手部門（2013～14） ベストナイン 一塁手部門（2015～16、2020） ゴールデングラブ賞（2015～16、2018、2020） スカパー！サヨナラ賞（2019.3･4）'),
(7, '吉田 輝星', '北海道日本ハムファイターズ', '投手', '2001-01-12', 20, 175, 85, '秋田県', '右投げ/右打ち', 'AB型', 2018, '金足農業高-北海道日本ハム（ドラフト1位・19～）', ''),
(8, '斎藤 佑樹', '北海道日本ハムファイターズ', '投手', '1988-06-06', 32, 176, 77, '群馬県', '右投げ/右打ち', 'A型', 2010, '早稲田実高-早稲田大-北海道日本ハム（ドラフト1位・11～） 2017シーズンより背番号を【1】へ変更', ''),
...
(29, '今宮 健太', '福岡ソフトバンクホークス', '内野手', '1991-07-15', 29, 172, 76, '大分県', '右投げ/右打ち', 'O型', 2009, '明豊高 - ソフトバンク（ドラフト1巡目・10～）', '（ベストナイン）14、17　（ゴールデングラブ）13、14、15、16、17'),
...
(34, '菅原　右敦', '北海道日本ハムファイターズ', '捕手', '2021-03-03', 20, 160, 65, '山形県', '左投げ/右打ち', 'B型', 2000, 'test', 'test');
